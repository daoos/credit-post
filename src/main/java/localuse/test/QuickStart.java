...
//                String url = "http://218.77.58.167:5005/api/abb";
                ...
                {
                    String s=
                            "同意吉林省志达酒业饮品有限公司授信方案如下：_x000D_\n" +
                                    "融资人：吉林省志达酒业饮品有限公司_x000D_\n" +
                                    "融资金额：人民币27.5亿元_x000D_\n" +
                                    "融资品种及用途：同业借款、融资性信托理财产品，用途为补充公司流动资金。_x000D_\n" +
                                    "期限：额度期限1年。额度内单笔同业借款期限不超过3年，融资性信托理财产品期限不超过3年。_x000D_\n" +
                                    "担保条件：生命人寿以其持有的大连樱华健康科技有限公司1.54%（4.4亿股）股权质押，质押率不超过50%。_x000D_\n" +
                                    "要求：_x000D_\n" +
                                    "（1）核实申请人投资股权行为及资金来源符合保监会相关规定，权属无瑕疵、无争议；_x000D_\n" +
                                    "（2）办妥股权质押；_x000D_\n" +
                                    "（3）完善相关法律合同文本，相关文本须经深圳分行法律室审定。建议关注北京四季花坛商贸有限公司“关于子公司大连樱华健康科技有限公司增资引进投资者的公告”（公告编号：临2014-040）中有关股权质押和转让的规定安排，尽量减少对我行的股权质押和转让行为的限制；_x000D_\n" +
                                    "（4）额度内具体业务需报相关业务部门审批，资金用途须合法合规。_x000D_\n" +
                                    "抄送：总行同业客户部";
