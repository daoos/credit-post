...
//                String url = "http://192.168.2.6:5002/cmb";
                ...
                if (tag == 1)
                {
                    String s=
                            "一、审贷结论\n" +
                                    "同意对大连城山贸易有限公司综合授信续期人民币4000万元（已有业务余额纳入），期限1年，业务品种：流动资金贷款、银行承兑汇票、国内信用证、履约类保函，贷款利率基准上浮不低于20%，承兑保证金不低于30%，保函保证金不低于20%，国内信用证保证金由客群部门确定。授信以申请人全资子公司南通祥太纺织国际有限公司名下位于武汉市新洲区阳逻街金阳大道51034.51平米工业用地（土地证号：武新国用（2013）第转053号）及地上建筑面积共计16166.89平米厂房抵押，抵押物评估净值4105.87万，抵押率不超过100%。追加南通祥太纺织国际有限公司担保。 \n" +
                                    "\n" +
                                    "二、放款条件\n" +
                                    "1、办\n" +
                                    "妥抵押登记手续；\n" +
                                    "2、我行授信仅用于流动资金，凭上下游合同用信，提款金额不超过提供的下游工程合同总额的60%，且我行融资对应合同项下应收账款不得质押给他行；\n" +
                                    "3、前期用信控制在2000万以内，剩余2000万结合申请人经营、回款等综合情况报分行授信部双签启用；\n" +
                                    "\n" +
                                    "三、贷后管理要求：\n" +
                                    "1、关注申请人工程垫资及回款情况，加强结算回款管理，结合我行账户流水判断经营规模与融资规模的匹配性，防范流动性风险；\n" +
                                    "2、关注申请人增资进展，其他板块业务的经营发展情况及盈利波动，若出现年度性亏损，应重点核实其经营性净现金流对利息支出的覆盖能力，并据此动态调整授信合作策略。 \n" +
                                    "3、要求我行贷款项目对应的应收账款应签署质押协议并办理登记，防止被用于他行融资。";
